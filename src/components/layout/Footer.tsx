...
const DEFAULT_FOOTER = {
  logoText: 'GameStation',
  companyDescription:
    'The ultimate gaming destination featuring the latest games, cutting-edge hardware, and immersive gaming experiences. Join millions of gamers worldwide who trust GameStation for their gaming needs.',
  contactEmail: 'hello@gamestation.com',
  contactPhone: '+1 (555) GAME-123',
  contactAddress: '456 Gaming Blvd, Suite 200',
  newsletterTitle: 'Game Updates',
  newsletterPlaceholder: 'Enter your email for game news',
  newsletterDisclaimer:
    'Get the latest game releases and exclusive offers. No spam, unsubscribe anytime.',
  section1Title: 'Games',
  section2Title: 'Platform',
  section3Title: 'Community',
  section4Title: 'Support',
  copyrightText: '© 2024 GameStation. All rights reserved.',
  madeWithText: 'by gamers, for gamers',
  socialText: 'Join our community:',
  social1Href: 'https://twitter.com/gamestation',
  social2Href: 'https://facebook.com/gamestation',
  social3Href: 'https://instagram.com/gamestation',
  social4Href: 'https://linkedin.com/company/gamestation',
  social5Href: 'https://github.com/gamestation',
  linkFeatures: 'New Releases',
  linkFeaturesHref: '#new-releases',
  linkPricing: 'Game Pass',
  linkPricingHref: '#gamepass',
  linkTemplates: 'Top Games',
  linkTemplatesHref: '/top-games',
  linkIntegrations: 'Multiplayer',
  linkIntegrationsHref: '/multiplayer',
  linkApi: 'Game API',
  linkApiHref: '/api',
  linkDocumentation: 'Game Guides',
  linkDocumentationHref: '/guides',
  linkAbout: 'About Us',
  linkAboutHref: '#about',
  linkBlog: 'Gaming News',
  linkBlogHref: '/news',
  linkCareers: 'Join Team',
  ...
  linkHelpHref: '/help',
  linkCommunity: 'Forums',
  linkCommunityHref: '/forums',
  linkTutorials: 'Game Tutorials',
  linkTutorialsHref: '/tutorials',
  linkWebinars: 'Live Streams',
  linkWebinarsHref: '/streams',
  linkCaseStudies: 'Success Stories',
  linkCaseStudiesHref: '/stories',
  linkStatus: 'Server Status',
  ...
  linkGdpr: 'Data Rights',
  linkGdprHref: '/data-rights',
  linkSecurity: 'Security',
  linkSecurityHref: '/security',
  linkCompliance: 'Fair Play',
  linkComplianceHref: '/fair-play',
  linkSitemap: 'Sitemap',
